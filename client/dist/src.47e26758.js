...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"assets/img/richard.JPG":[function(require,module,exports) {
module.exports = "/richard.17e35c97.JPG";
},{}],"components/start.js":[function(require,module,exports) {
'use strict';
...
var _richard = require('../assets/img/richard.JPG');

var _richard2 = _interopRequireDefault(_richard);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'figure',
                    { className: 'round' },
                    _react2.default.createElement('img', { src: _richard2.default, alt: 'Photo of Richard\'s beautiful mug.' })
                ),
                _react2.default.createElement(
                    'h1',
                    null,
                ...
                _react2.default.createElement(
                    'p',
                    null,
                    'Does it sometimes seem like Richard has dissapeared from the world? Doesn\'t he awnser his phone? Neither his email? He might be buzzy behind his computer and not really thirsty for digital messages. So, let\'s make some analog ones. Unfortunantly, postcards are quite slow. Our solotion: drop your message here and we will print it out and put it in front of his face.'
                ),
                _react2.default.createElement(
                    'button',
                    { value: 'message', onClick: this.props.onClick },
                    'New Message'
                ),
                _react2.default.createElement(
                    'p',
                    ...
                    _react2.default.createElement(
                        'a',
                        { href: '#wow-we-did-not-think-somebody-would-actiually-read-this' },
...
},{"react":"../node_modules/react/index.js","../assets/img/richard.JPG":"assets/img/richard.JPG"}],"../node_modules/react-keypress/dist/reactKeypress.js":[function(require,module,exports) {
var define;
...
exports.TextArea = exports.TextField = undefined;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    null,
                    "What is your ",
                    this.props.name == "phone" ? "phone number" : this.props.name,
                    "?"
                ),
                _react2.default.createElement("input", _defineProperty({ name: this.props.name, value: this.props.value, onChange: this.props.onChange, key: this.props.value, placeholder: this.props.name, type: this.props.type }, "placeholder", this.props.name))
            );
        }
    }]);
...
var TextArea = exports.TextArea = function (_React$Component2) {
    ...
    _createClass(TextArea, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement("textarea", { name: this.props.name, value: this.props.value, onChange: this.props.onChange, key: this.props.value, placeholder: this.props.name, id: "", cols: "50", rows: "10" })
            );
        }
    }]);
...
var _reactKeypress = require('react-keypress');
...
var Message = exports.Message = function (_React$Component) {
    ...
    function Message(props) {
        ...
        _this.docRef = db.doc("Users/" + _this.state.recipient + "/Messages/" + _this.autoID(10));
        return _this;
    }
    ...
    _createClass(Message, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'form',
                { id: 'message' },
                _react2.default.createElement(_input.TextField, { key: 'input-1', value: this.state.name, onChange: this.handleInput.bind(this), name: 'name', type: 'text' }),
                _react2.default.createElement(_input.TextField, { key: 'input-2', value: this.state.email, onChange: this.handleInput.bind(this), name: 'email', type: 'email' }),
                _react2.default.createElement(_input.TextField, { key: 'input-3', value: this.state.phone, onChange: this.handleInput.bind(this), name: 'phone', type: 'text' }),
                _react2.default.createElement(_input.TextArea, { key: 'input-4', value: this.state.message, onChange: this.handleInput.bind(this), name: 'message' }),
                _react2.default.createElement(
                    'button',
                    { id: 'submit', onClick: this.handleSubmit.bind(this) },
                    ' Send Message'
                )
            );
        }
...
},{"react":"../node_modules/react/index.js","react-keypress":"../node_modules/react-keypress/dist/reactKeypress.js","../components/input":"components/input.js"}],"assets/img/success.gif":[function(require,module,exports) {
module.exports = "/success.6d1d9866.gif";
...
var _success = require('../assets/img/success.gif');
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'figure',
                    { className: 'round' },
                    _react2.default.createElement('img', { src: _success2.default, alt: 'Success' })
                ),
                _react2.default.createElement(
                    'h1',
                    null,
                ...
                _react2.default.createElement(
                    'p',
                    null,
                    'Richard will react as soon as possible'
                ),
                _react2.default.createElement(
                    'button',
                    null,
...
},{"react":"../node_modules/react/index.js","../assets/img/success.gif":"assets/img/success.gif"}],"components/close.js":[function(require,module,exports) {
'use strict';
...
var Close = exports.Close = function (_React$Component) {
...
},{"react":"../node_modules/react/index.js"}],"components/terms.js":[function(require,module,exports) {
"use strict";
...
var Terms = exports.Terms = function (_React$Component) {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "p",
                    null,
                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc tristique rutrum ipsum quis elementum. Donec sit amet tempus dui. Fusce posuere magna accumsan aliquam tempor. Morbi scelerisque libero sit amet lacus rhoncus, at volutpat est convallis. Duis condimentum vitae purus faucibus mollis. Pellentesque justo eros, ornare ut justo ac, finibus aliquam magna. Praesent ac tortor tempus, lacinia metus ac, rhoncus felis. Nullam aliquam euismod turpis. Vivamus congue nulla mauris, in congue mi malesuada sit amet. Mauris vel lorem euismod, suscipit libero ac, bibendum dui. Phasellus faucibus diam nec commodo sollicitudin. Integer in mauris vitae erat venenatis rutrum ut eu est. Quisque euismod eros urna, ac feugiat neque laoreet at. Sed lacinia commodo odio vel tempus. Fusce pellentesque in turpis quis venenatis. Aliquam sodales cursus ante, ut convallis orci fermentum non. Pellentesque a mauris nec ligula cursus pulvinar at at libero. Praesent libero dui, viverra ac venenatis ac, gravida sed nunc. Maecenas eleifend dapibus semper. Nunc lacinia lorem at ex hendrerit blandit. Suspendisse varius tellus erat, nec maximus metus fringilla ut. Pellentesque consequat aliquet mollis. Praesent cursus quis lectus sit amet convallis. Suspendisse eu nisi est. Praesent in arcu purus. Aliquam vel imperdiet enim. Suspendisse molestie diam lectus, ut sodales ante porttitor vel. Praesent sit amet neque porta, blandit urna eu, egestas tellus. Fusce dapibus molestie eros vel ultrices. Aliquam erat volutpat. Proin erat ipsum, vulputate at dapibus consequat, molestie eu nisl. Aliquam mollis velit nunc. Aenean imperdiet vestibulum gravida. Nullam blandit leo magna. Aliquam dictum ultricies justo, vel rhoncus mi congue non. Integer id lacus ut est efficitur molestie quis at felis. Suspendisse pharetra mauris quis augue elementum tristique. Vestibulum quis diam a nulla fringilla maximus. Aenean et dolor nec erat varius sagittis. Sed ornare tortor id iaculis lacinia. Ut pharetra quam nec metus convallis facilisis. In accumsan ullamcorper dolor condimentum ultricies. Suspendisse mollis dui ac massa bibendum rhoncus. Fusce ut euismod lorem. Praesent hendrerit justo in lectus tempus efficitur. Morbi gravida est non ornare efficitur. Vestibulum congue vel neque quis pulvinar. Donec id dictum mi, a condimentum justo. Vestibulum et ipsum posuere dui pulvinar placerat quis et tortor. Pellentesque pharetra bibendum nisl, in posuere diam. Vestibulum id purus sed dui imperdiet egestas sed quis nisi. Donec luctus ullamcorper luctus. Integer sem purus, lobortis sit amet nisl eget, molestie congue sem. In varius, eros vitae congue fermentum, velit urna rutrum mi, vitae sagittis turpis augue a felis. Morbi ultricies nisi lacus, vel ullamcorper libero viverra vel. Phasellus ultricies consectetur ligula, eget aliquam turpis molestie eu. Integer volutpat in erat et ultrices. Ut dapibus blandit velit vel faucibus. Duis euismod ex nec diam semper, id molestie ante egestas. Vestibulum finibus, nunc vitae congue lobortis, mauris mauris pulvinar odio, rutrum tempor magna libero ut mauris. In vel convallis nulla. "
                )
            );
        }
    }]);
...
var Controller = function (_React$Component) {
    ...
    _createClass(Controller, [{
        key: 'changeScreen',
        value: function changeScreen(newScreen) {
            this.setState({
        ...
        value: function toggle() {
            var newScreen = this.state.screen;
            if (newScreen === 'message') {
                return _react2.default.createElement(_message.Message, null);
            } else {
                return _react2.default.createElement(_start.Start, { onClick: this.changeScreen });
            }
        }
    }, {
        key: 'render',
...
_reactDom2.default.render(_react2.default.createElement(Controller, null), ROOT);
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./components/start":"components/start.js","./components/message":"components/message.js","./components/notification":"components/notification.js","./components/close":"components/close.js","./components/terms":"components/terms.js","./components/about":"components/about.js","./styles/style.scss":"styles/style.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/src.47e26758.map