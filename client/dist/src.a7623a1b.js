...
module.exports = "/richard.ff5b4ca7.JPG";
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement("input", _defineProperty({ name: this.props.name, placeholder: this.props.name, type: this.props.type }, "placeholder", this.props.name))
            );
        }
    }]);
    ...
    _createClass(TextArea, [{
        ...
        value: function render(props) {
            return _react2.default.createElement(
                ...
                _react2.default.createElement("textarea", { name: "message", id: "", cols: "50", rows: "10" })
            );
        }
    }]);
...
var Message = exports.Message = function (_React$Component) {
    ...
    function Message(props) {
        ...
        var metadata = {
            ...
            clientID: "1",
            recipient: "Richard",
            docRef: db.doc("Users/" + _this.recipient + "/Messages/" + _this.autoID(10))
        };
    ...
    _createClass(Message, [{
        ...
        value: function render() {
            console.log();
            var fields = [];
            /* ['Name', 'text'], ['Phone', 'text'], ['E-mail', 'email'] */
            for (var i = 0; this.state.fieldCount <= i; i++) {
                this.fields.push(_react2.default.createElement(_input.TextField, null));
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { id: 'submit', onClick: this.handleAddField },
                    ' Next'
                )
            );
        }
...
module.exports = "/success.c3a97945.gif";
...
//# sourceMappingURL=/src.a7623a1b.map